...
export default function NewItem({onAddItem}) {
    ...
    const handleSubmit = (event) => {
        ...
        const newitems = {id:newID, name, quantity, category};
        onAddItem(newitems);
    ...
    return(
        <main className= "flex justify-left">
            <form onSubmit={handleSubmit}  className= "p-4 mt-4 ml-4 border-black border-2 ml-12 bg-gray-700 w-full max-w-sm flex-col">
